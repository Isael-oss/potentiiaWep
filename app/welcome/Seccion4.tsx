    ...
    return (
      <section className="bg-[#E0467A] w-full min-h-screen md:min-h-[559px] py-16 px-4 text-white relative overflow-hidden">
        ...
        <img 
          ...
          className="absolute w-[1147px] h-[378.44px] top-[-160px] left-[1593.21px] border-2 border-white pointer-events-none bg-[url('/Line2.png')] bg-cover bg-center z-10 origin-center -rotate-[61.38deg]"
        />
      </section>
    );
  };